...
const MaterialAppBar = ({ history }) => {
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem onClick={handleMenuClose}>Mening akkauntim</MenuItem>
    </Menu>
  );
        ...
        <Toolbar>
          ...
          <div className={classes.sectionDesktop}>
            <Link style={isActive(history, '/')} to='/'>
              <IconButton aria-label='Home' color='inherit'>
                <HomeIcon />
                <Typography noWrap>Asosiy</Typography>
              </IconButton>
            </Link>
            ...
            <Link style={isActive(history, '/shop')} to='/shop'>
              <IconButton aria-label='Shop' color='inherit'>
                <StorefrontIcon />
                <Typography noWrap>Do'kon</Typography>
              </IconButton>
            </Link>
            ...
            <Link style={isActive(history, '/cart')} to='/cart'>
              <IconButton aria-label='Cart' color='inherit'>
                ...
                <Typography noWrap>Savat</Typography>
              </IconButton>
            </Link>
            ...
            {isAuthenticated() && isAuthenticated().user.role === 0 && (
              ...
              >
                <IconButton aria-label='Dashboard' color='inherit'>
                  <DashboardIcon />
                  <Typography noWrap>Boshqaruvchi</Typography>
                </IconButton>
              </Link>
            )}
            ...
            {!isAuthenticated() && (
              <Fragment>
                <Link style={isActive(history, '/signin')} to='/signin'>
                  <IconButton aria-label='Signin' color='inherit'>
                    <AccountCircleIcon />
                    <Typography noWrap>Kirish</Typography>
                  </IconButton>
                </Link>
                ...
                <Link style={isActive(history, '/signup')} to='/signup'>
                  <IconButton aria-label='Signup' color='inherit'>
                    <PersonAddIcon />
                    <Typography noWrap>Ro'yhatdan O'tish</Typography>
                  </IconButton>
                </Link>
              </Fragment>
            )}
            ...
            {isAuthenticated() && (
              ...
              >
                <IconButton aria-label='Signout' color='inherit'>
                  <ExitToAppIcon />
                  <Typography noWrap>Chiqish</Typography>
                </IconButton>
              </span>
            )}
          </div>
